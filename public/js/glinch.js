<!-- Tweakpane library and main script with type="module" -->
    <script type="module">
        // Import Pane and FolderApi from the Tweakpane library
        import { Pane, FolderApi } from "https://cdn.skypack.dev/tweakpane@4.0.4";

        // Utility for MIME types
        const mimeTypeUtils = {
        ...
        const TweakpaneUtils = {
            ...
            enableAccordion(pane, targetTitles = null, defaultOpen = null) {
                ...
                function registerFolder(folder) {
                    // Use FolderApi from the imported Tweakpane module
        ...
        document.addEventListener("DOMContentLoaded", () => {
            // Instantiate Pane after it's imported
            const pane = new Pane();
            ...
            function makeScaledWaveDeformEffect(scale = 1) {
                return function(inputImageData, output) {
                    const scaledParams = {
                        ...
                        frequency: waveDeformParams.frequency / scale,
                    };
            ...
            function makeScaledDisplacementEffect(scale = 1) {
                return function(inputImageData, output) {
                    const scaledParams = {
                        ...displacementParams,
                        displacementIntensity: displacementParams.displacementIntensity,
                        displacementSize: Math.max(1, Math.round(displacementParams.displacementSize * scale)),
                        displacementFrequency: displacementParams.displacementFrequency
                    };
